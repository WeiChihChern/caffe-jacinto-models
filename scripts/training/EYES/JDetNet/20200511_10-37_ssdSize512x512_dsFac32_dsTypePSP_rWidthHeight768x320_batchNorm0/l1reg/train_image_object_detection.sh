...
weights_dst="/workspace/caffe-jacinto-models/trained/object_detection/voc0712/JDetNet/ssd512x512_ds_PSP_dsFac_32_fc_0_hdDS8_1_kerMbox_3_1stHdSameOpCh_1/sparse/voc0712_ssdJacintoNetV2_iter_104000.caffemodel"
...
then
  ...
  max_iter=10000    #120000  #64000   #32000
...
l1reg_solver_param="{'snapshot':$snapshot,'test_interval':$test_interval,'type':'$type','base_lr':$base_lr_L1,'max_iter':$max_iter,'lr_policy':'$lr_policy','power':$power,'stepvalue':[$stepvalue1_L1,$stepvalue2_L1,$stepvalue3],\
...
sparse_solver_param="{'snapshot':$snapshot,'test_interval':$test_interval,'type':'$type','base_lr':$base_lr,'max_iter':$max_iter,'lr_policy':'$lr_policy','power':$power,'stepvalue':[$stepvalue1,$stepvalue2,$stepvalue3],\
'regularization_type':'L1','weight_decay':1e-5,\
'sparse_mode':1,'display_sparsity':2000,\
'sparsity_target':0.75,'sparsity_start_iter':0,'sparsity_start_factor':$sparsity_start_factor,\
